...
In the SyncoPaid case, `pynput` wasn't installed, causing action screenshots to silently not work. The root cause was only discovered after extensive debugging.
