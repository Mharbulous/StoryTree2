...
- `wishlisted` (status): "Not now, but maybe later" - indefinite hold, can be revived when priorities change
- `rejected` (terminus): "No, this doesn't fit" - terminal state, excluded permanently
