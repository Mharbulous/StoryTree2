...
2. **Load story context** - Read story description, acceptance criteria
3. **Check stage** - Adjust review focus based on current stage

### Phase 2: Run Automated Checks

```bash
# Python projects (SyncoPaid)
...
### Phase 5: Attach to Story

1. **Update story notes** - Append review summary
2. **Create artifact** - Save to `${STORYTREE_DATA_DIR}/reviews/{story_id}_{timestamp}.md`
3. **Set escalated** - Transition to escalated hold
...
```
/AI-review --story-id=[ID] --stage=[current_stage]
```
