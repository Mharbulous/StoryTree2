...
Generate `patterns.md` and `anti-patterns.md` in `${STORYTREE_DATA_DIR}/design/`.
...
- Read existing `${STORYTREE_DATA_DIR}/design/patterns.md` for context (if exists)
- Write `${STORYTREE_DATA_DIR}/design/patterns.md` with sections:
...
- Read existing `${STORYTREE_DATA_DIR}/design/anti-patterns.md` for context (if exists)
- Write `${STORYTREE_DATA_DIR}/design/anti-patterns.md` with sections:
