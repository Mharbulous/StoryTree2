...
**Arguments:**
- `$ARGUMENTS` - Path to the plan file (e.g., `${STORYTREE_DATA_DIR}/plans/024_feature.md`)
...
3. Save sub-plans to `${STORYTREE_DATA_DIR}/plans/`
...
1. Run: `ls -1 ${STORYTREE_DATA_DIR}/plans/*.md` to see existing plans
2. Run: `ls -1 ${STORYTREE_DATA_DIR}/plans/executed/*.md` to see executed plans
3. Run: `ls -1 ${STORYTREE_DATA_DIR}/plans/decomposed/*.md` to see decomposed parent plans
...
```json
{
  ...
  "task_count": 5,
  "execute_plan": "${STORYTREE_DATA_DIR}/plans/016_configurable-idle-threshold.md",
  "sub_plans_created": [],
  "parent_moved": false,
...
```json
{
  "complexity": "complex",
  "task_count": 12,
  "execute_plan": "${STORYTREE_DATA_DIR}/plans/016A_idle-threshold-validation.md",
  "sub_plans_created": [
...
1. Move the PARENT plan to `${STORYTREE_DATA_DIR}/plans/decomposed/` folder
