...
**Option 2: Fresh session** - Open new Claude Code session, say "Execute plan: ${STORYTREE_DATA_DIR}/plans/[filename]"
...
1. Execute: ${STORYTREE_DATA_DIR}/plans/045_[slug]-db-schema.md
   Verify: [verification command]

2. Execute: ${STORYTREE_DATA_DIR}/plans/046_[slug]-core-logic.md
   Verify: [verification command]
