...
Implement all tasks in the plan following strict RED-GREEN-COMMIT cycle.
...
Read the entire plan first, then implement each task sequentially.
...
At the end, write the result to `.claude/skills/story-execution/ci-implement-result.json`:
